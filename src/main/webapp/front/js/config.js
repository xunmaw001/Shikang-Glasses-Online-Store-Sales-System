...
var indexNav = [
    ...
    {
        name: '眼镜',
        url: './pages/yanjing/list.html'
    },

]

var adminurl =  "http://localhost:8080/shikangyanjingwangdianxiaoshou/admin/dist/index.html#/login";
