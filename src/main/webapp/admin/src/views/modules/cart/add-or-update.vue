    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="镜框材质" prop="caizhiValue">
                        <el-input v-model="yanjingForm.caizhiValue"
                                  placeholder="镜框材质" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="镜片材质" prop="jingpianValue">
                        <el-input v-model="yanjingForm.jingpianValue"
                                  placeholder="镜片材质" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="镜片品牌" prop="pinpaiValue">
                        <el-input v-model="yanjingForm.pinpaiValue"
                                  placeholder="镜片品牌" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="镜片折射率" prop="zhesheValue">
                        <el-input v-model="yanjingForm.zhesheValue"
                                  placeholder="镜片折射率" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="颜色" prop="yanseValue">
                        <el-input v-model="yanjingForm.yanseValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="眼镜配件" prop="peijianValue">
                        <el-input v-model="yanjingForm.peijianValue"
                                  placeholder="眼镜配件" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="购买获得积分" prop="shangpinPrice">
                        <el-input v-model="yanjingForm.shangpinPrice"
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="眼镜库存" prop="yanjingKucunNumber">
                        <el-input v-model="yanjingForm.yanjingKucunNumber"
                                  placeholder="眼镜库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="眼镜原价" prop="yanjingOldMoney">
                        <el-input v-model="yanjingForm.yanjingOldMoney"
                                  placeholder="眼镜原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yanjing' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="yanjingClicknum">
                        <el-input v-model="yanjingForm.yanjingClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="yanjingClicknum">
                            <el-input v-model="ruleForm.yanjingClicknum"
