    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                YanjingEntity yanjing = yanjingService.selectById(cart.getYanjingId());
                if(yanjing != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("yanjing_id", cart.getYanjingId())
...
//                            cartEntity.setYanjingId(Integer.valueOf(data.get(0)));   //眼镜 要改的
