...
public class YanjingCommentbackView extends YanjingCommentbackEntity implements Serializable {
	...
	public YanjingCommentbackView() {

	}

	public YanjingCommentbackView(YanjingCommentbackEntity yanjingCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, yanjingCommentbackEntity);
